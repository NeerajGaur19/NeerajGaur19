...
### Step 1: Standardize Data or mean centering of data
...
Note : Mean centering of data - This approach is when mean of data point is taken and distance of each data point with mean is calculated. And then next step is to move the mean of data to 0,0 coordinate and move data points respectively. 
